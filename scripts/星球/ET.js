const MFlib = require("base/MFlib");
const TBLY = new Planet("ET", Planets.sun, 1, 3.3);
...
const 降落区 = new SectorPreset("降落区", TBLY, 1);
降落区.description = "我们选择了一个敌人偏远的储存区进行突袭，夺下这个地区，然后想办法与主力部队取得联系";
降落区.difficulty = 2;
降落区.alwaysUnlocked = false;
降落区.addStartingItems = true;
降落区.captureWave = 0;
降落区.localizedName = "降落区";
exports.降落区 = 降落区;
MFlib.addToResearch(降落区, {
...
exports.荒芜矿区 = 荒芜矿区;
MFlib.addToResearch(荒芜矿区, {
	parent: "降落区",
	objectives: Seq.with(
	new Objectives.SectorComplete(降落区))
})
